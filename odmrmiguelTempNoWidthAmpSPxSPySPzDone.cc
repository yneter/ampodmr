...
struct FitParameters {
  ...
  FitParameters(const DataForODMR &odata) : itauspin( 4.0 ),
			 ...
			 PL_rate_names( { "PL.SPz2", "PL.SPy2", "PL.SPx2" } ),   
			 Gen_rate_names( { "Gen.SPz2", "Gen.SPy2", "Gen.SPx2" } )
  {
...
{   
  // 0.04 0.04 1 1450 0
   ...
   std::cout << "# Jdip " << odata.triplet_pair.Jdip << "  " << std::endl;
   ...
   ****/
   ...
   std::vector<double> xinit { 1.49816, 1.29026, 4.72083,
    3.5874, 0.0286772, 4.98544,
    6.28259 , 0.215819 , 0.0284849 , 0.491015 };

   Fit.set_from_vector(xinit);
   
   //   std::cout << "# Singlet wavefunction " << std::endl;
   //   std::cout << odata.triplet_pair.singlet() << std::endl;
